...
class Uauth
{
    ...
    public function __construct()
    {
        ...
        $this->_expireRememberMe = $this->_expireRememberMe != "" ? $this->_expireRememberMe : 60 /*sec*/ * 60 /*minutes*/ * 24 /*hour*/ * 30 /*day*/ * 6;
    ...
    public function IsValidUser($username, $password, $hashType = "")
    {
    ...
    private function _isRememberMe()
    {
        ...
        if ($auth_tokens == '') {
            ...
            //get user id based on tokens and site url
            $user_auth =  $this->CI->db->get_where('auth_tokens', array('token' => hash('sha256', $auth_tokens), 'site_url' => base_url()))->row();
