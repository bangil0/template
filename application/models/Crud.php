...
class Crud extends CI_Model {
    ...
    public function glike($t,$like){return $this->db->like($like)->get($t)->result();}
    ...
    public function gdo($t,$w,$o){return $this->db->where($w)->order_by($o)->get($t)->row();}
    ...
    public function gdao($t,$w,$o){return $this->db->where($w)->order_by($o)->get($t)->row_array();}
    // Get single data as object array with where condition
    public function gwra($t,$w){return $this->db->where($w)->get($t)->result_array();}
    // Insert Data
